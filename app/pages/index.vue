...
onMounted(() => {
  ...
  const ctx = gsap.context(() => {
    ...
    tl.from("[data-hero-kicker]", { autoAlpha: 0, y: 24, duration: 0.7 }, 0.15)
      ...
      .from("[data-hero-note]", { autoAlpha: 0, scale: 0.6, rotate: -14, duration: 0.6, ease: "back.out(2)" }, 1.0)
      .from("[data-hero-desc]", { autoAlpha: 0, y: 20, duration: 0.7 }, 1.05)
      .from("[data-hero-cta]", { autoAlpha: 0, y: 16, duration: 0.6, stagger: 0.08 }, 1.15)
      .from("[data-hero-meta]", { autoAlpha: 0, y: 14, duration: 0.6 }, 1.25)
      .from("[data-hero-hint]", { autoAlpha: 0, duration: 0.8 }, 1.6);
...
<template>
  <div>
    ...
    <section ref="heroRef" class="relative flex min-h-screen flex-col justify-center overflow-hidden pt-24 pb-16">
      <!-- 右上角橙色氛围光 -->
      <div
        class="pointer-events-none absolute -top-40 right-[-10%] size-[34rem] rounded-full opacity-60 blur-[120px]"
      ...
      <div class="mx-auto grid w-full max-w-7xl items-center gap-14 px-5 md:px-10 lg:grid-cols-12">
        ...
        <div class="relative lg:col-span-7">
          ...
          <SplitHeading
            text="MIXSU"
            as="h1"
            class="font-display text-[clamp(4rem,13vw,9.5rem)] font-extrabold leading-[0.95] tracking-tight text-text"
          />
          ...
          <div class="mt-6 flex items-start gap-4">
            ...
            <HandNote data-hero-note text="你好呀，欢迎光临 ✦" class="mt-1 shrink-0 text-xl md:text-2xl" />
          </div>
          ...
          <div class="mt-9 flex flex-wrap items-center gap-4">
            ...
            >
              查看作品
              <UIcon name="lucide:arrow-down-right" class="size-4 transition-transform duration-300 group-hover:rotate-45" />
            </NuxtLink>
            <NuxtLink
              data-hero-cta
              to="/blog"
            ...
            >
              阅读博客
              <UIcon name="lucide:arrow-right" class="size-4 transition-transform duration-300 group-hover:translate-x-1" />
            </NuxtLink>
          </div>

          <div data-hero-meta class="mt-10 flex flex-wrap gap-x-8 gap-y-2 font-mono text-xs text-faint">
            <span>✂ 剪辑 6+ 年</span>
            <span>◈ Blender 3 年</span>
            <span>&lt;/&gt; 前端 4 年</span>
          </div>
        </div>
        ...
        <div class="relative lg:col-span-5">
          <div class="relative mx-auto max-w-sm">
            ...
            >
              ...
              />
              <!-- 底部渐变 -->
              <div class="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-bg/70 to-transparent" aria-hidden="true" />
            </div>
            ...
            <HandNote
              data-hero-note
              text="这就是我 ✎"
              class="absolute -bottom-5 -left-4 z-10 rounded-lg bg-accent px-3 py-1 text-lg text-bg shadow-lg md:-left-8"
              :rotate="-5"
            />
    ...
    <section ref="manifestoRef" class="mx-auto max-w-5xl px-5 py-32 md:px-10 md:py-44">
      ...
      <p class="hand-note mt-12 text-2xl text-muted md:text-3xl">—— 我给自己定的小规矩</p>
    </section>
    ...
    <section class="mx-auto max-w-7xl px-5 py-16 md:px-10">
      <div class="flex flex-wrap items-end justify-between gap-6">
        <SectionHeading
          ...
          title="精选作品"
          description="从赛博城市到混剪短片，挑几件最近最满意的放前面。"
        />
    ...
    <section class="mx-auto max-w-7xl px-5 py-16 md:px-10">
      <div class="flex flex-wrap items-end justify-between gap-6">
        <SectionHeading
          ...
          kicker="Latest Notes"
          title="最近在写"
          description="技术笔记与生活随笔，更新频率取决于我有多勤快。"
        />
        <Reveal variant="fade" :delay="0.2">
    ...
    <section class="mx-auto max-w-7xl px-5 py-28 md:px-10">
      ...
      <Reveal variant="up" :delay="0.15" class="mt-8">
        <div class="flex flex-wrap items-center gap-8">
          ...
          <HandNote text="合作、闲聊、催更，都欢迎" class="text-xl md:text-2xl" />
        </div>
      </Reveal>
    </section>
  </div>
