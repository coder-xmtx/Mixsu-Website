...
<template>
  <Reveal variant="up" :delay="Math.min(index * 0.08, 0.3)" :y-offset="40">
    ...
    >
      ...
      <div>
        <h3 class="font-display text-lg font-bold tracking-tight text-text transition-colors duration-300 group-hover:text-accent md:text-xl">
          {{ title }}
        </h3>
      ...
      <div class="flex items-center gap-3 md:justify-end">
        <span class="inline-flex items-center gap-1.5 rounded-full border border-line px-2.5 py-1 font-mono text-[11px] tracking-widest text-muted">
